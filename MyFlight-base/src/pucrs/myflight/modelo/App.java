...
public class App {
	...
	public static void main(String[] args) {	
		...
		//**********************************************************************************************************
		//Aeronaves
		//As aeronaves são identificadas por um código, uma descrição e uma capacidade de passageiros:
		...
		//**********************************************************************************************************
		//Aeroportos
		//Os aeroportos possuem um código, um nome e uma localização geográfica (latitude e longitude):		
		...
		//**********************************************************************************************************
		//Voos
		//Um vôo é descrito por uma data e horário, duração, rota e estado (confirmado, atrasado ou cancelado):
